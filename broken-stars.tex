...
\begin{document}
  ...
  \begin{enumerate}
    ...
    \begin{standardtable}{\linewidth}{sb}
      \textbf{Trait} & \textbf{Description}\\
      Pace      & Calculated as: \textbf{(Engines / 2) + 2}. How many squares of movement you can take during your turn.\\
      Evade     & Calculated as: \textbf{(Manuever / 2) + 2}. Target number for combat.\\
  ...
  \begin{standardtable}{\linewidth}{ssssssss}
    \textbf{Hull} & \textbf{Base Cost} & \textbf{Base Crew} & \textbf{Storage} & \textbf{Base Power} & \textbf{Size} & \textbf{Pace Mod} & \textbf{Class}\\
    Fighter     & 200k  & 1   & 2   & 3   & -1  & +5  & Fighter\\
    Shuttle     & 500k  & 1   & 5   & 3   & 0   & +2  & Small\\
    Patrol      & 1.5m  & 5   & 10  & 10  & 0   & +2  & Small\\
    Corvette    & 2.5m  & 10  & 15  & 10  & +1  & +2  & Small\\
    Frigate     & 4.5m  & 30  & 15  & 30  & +4  & 0   & Medium\\
    Cruiser     & 8m    & 50  & 30  & 50  & +5  & 0   & Medium\\
    Battleship  & 13m   & 100 & 50  & 75  & +8  & -2  & Large\\
    Capital     & 20m   & 200 & 100 & 75  & +10 & -2  & Large\\
  \end{standardtable}
